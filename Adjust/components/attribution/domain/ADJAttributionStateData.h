...
FOUNDATION_EXPORT NSString *const ADJAttributionStateStatusWaitingForInstallSessionTracking;
FOUNDATION_EXPORT NSString *const ADJAttributionStateStatusCanAsk;
FOUNDATION_EXPORT NSString *const ADJAttributionStateStatusIsAsking;
