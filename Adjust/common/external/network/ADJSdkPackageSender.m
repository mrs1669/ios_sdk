...
@property (nullable, readonly, weak, nonatomic)
    id<ADJSdkPackageSendingSubscriber> sdkPackageSendingCollectorWeak;
@property (nullable, readonly, weak, nonatomic)
    id<ADJSdkResponseSubscriber> sdkResponseCollectorWeak;
...
@property (nullable, readonly, strong, nonatomic)
    ADJSdkPackageSenderPinningDelegate *sdkPackageSenderPinningDelegate;
@end
...
- (nonnull NSURLRequest *)buildUrlRequestWithBuilder:
...
- (nullable ADJStringMap *)
    publishPackageSendingAngGetHeadersToSendWithSdkPackage:
        (nonnull id<ADJSdkPackageData>)sdkPackageData
    sendingParameters:(nonnull ADJStringMapBuilder *)sendingParameters
{
...
- (nonnull NSMutableURLRequest *)
    buildMutableUrlRequestWithSdkPackageData:(nonnull id<ADJSdkPackageData>)sdkPackageData
...
- (void)
    injectUrlEncodedPairsWithParameters:(nonnull ADJStringMap *)parametersToInject
...
- (void)
    retryOrReturnWithSdkResponseBuilder:(nonnull ADJSdkResponseDataBuilder *)sdkResponseBuilder
    threadpool:(nonnull id<ADJThreadPool>)threadpool
{
    BOOL retryToSend =
...
- (void)
    failToProcessLocallyWithResponseBuilder:(nonnull ADJSdkResponseDataBuilder *)sdkResponseBuilder
