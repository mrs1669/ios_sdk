...
- (nonnull ADJNonEmptyString *)
    concreteGenerateSelectSqlWithTableName:(nonnull NSString *)tableName
{
    [self doesNotRecognizeSelector:_cmd];
    return nil;
}
- (nonnull ADJNonEmptyString *)
    concreteGenerateInsertSqlWithTableName:(nonnull NSString *)tableName
{
    [self doesNotRecognizeSelector:_cmd];
    return nil;
}
...
- (nonnull ADJNonEmptyString *)generateDeleteAllSqlWithTableName:
