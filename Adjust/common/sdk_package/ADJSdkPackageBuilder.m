...
@property (nullable, readonly, weak, nonatomic)
    ADJGlobalCallbackParametersStorage *globalCallbackParametersStorageWeak;
@property (nullable, readonly, weak, nonatomic)
    ADJGlobalPartnerParametersStorage *globalPartnerParametersStorageWeak;
@property (nullable, readonly, weak, nonatomic)
    ADJEventStateStorage *eventStateStorageWeak;
@property (nullable, readonly, weak, nonatomic)
...
{
    ADJStringMapBuilder *_Nonnull parametersBuilder =
        [self generateParametersBuilderWithPath:ADJEventPackageDataPath
                                   apiTimestamp:apiTimestamp
...
- (nonnull ADJSessionPackageData *)buildSessionPackageWithDataToOverwrite:
    (nonnull ADJPackageSessionData *)packageSessionDataOverwrite
{
    ADJStringMapBuilder *_Nonnull parametersBuilder =
...
- (void)
    injectClientConfigFieldsWithParametersBuilder:(nonnull ADJStringMapBuilder *)parametersBuilder
    path:(nullable NSString *)path
{
    [ADJUtilMap injectIntoPackageParametersWithBuilder:parametersBuilder
...
- (void)
    injectEventStateFieldsWithParametersBuilder:
        (nonnull ADJStringMapBuilder *)parametersBuilder
    path:(nullable NSString *)path
{
...
- (void)
    injectMeasurementSessionFieldsWithParametersBuilder:
        (nonnull ADJStringMapBuilder *)parametersBuilder
    path:(nullable NSString *)path
    packageSessionDataOverwrite:(nullable ADJPackageSessionData *)packageSessionDataOverwrite
{
...
- (nonnull ADJStringMap *)
    publishAndGenerateParametersWithParametersBuilder:
        (nonnull ADJStringMapBuilder *)parametersBuilder
